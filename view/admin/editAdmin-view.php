            ...
            <div class="side-menu-area">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="../admin/admin-view.php"><i class="fa fa-eye"></i>Admin</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                                ...
                                <div class="ibox bg-boxshadow mb-30">
                                    ...
                                    <div class="ibox-content">
                                        <?php foreach ($anggota->edit() as $data): ?>
                                            <form action="../../model/Validate.php?aksi1=updateA" method="post">
                         ...
                         <div class="form-group mb-0 row">
                            <div class="col-12">
                                <a href="admin-view.php" style="color: silver">
