            ...
            <div class="side-menu-area">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="admin-view.php"><i class="fa fa-eye"></i>Admin</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
                            ...
                            <div class="user-meta-data d-flex align-items-center">
                                ...
                                <div class="topbar-profile">
                                    ...
                                    <div class="profile-data">
                                        ...
                                        <div class="profile-user--details" style="background-image: url(.public/img/thumbnails-img/profile-bg.jpg);">
                                            <!-- Thumb -->
                                            ...
                                            <div class="ibox-content">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-bordered table-hover dataTables-example">
                                                        ...
                                                        <tbody>
                                                            <?php if (is_array($kelas->tampil_kelasU())): $no = 1;?>
                                                                <?php foreach ($kelas->tampil_kelasU() as $data):?>
                                                                    ...
                                                                    <tr class="gradeX">
                                                                        ...
                                                                        <td align="center">
                                                                            <a href="editAdmin-view.php?id=<?php echo $data['id']; ?>&aksi1=edit" class="btn m-2 btn-round btn-primary"><i class="fa fa-edit fa-2x"></i></a>
                                                                            <a href="../../model/Validate.php?id=<?php echo $data['id']; ?>&aksi1=hapus" class="btn m-2 btn-round btn-danger delete"><i class="fa fa-trash fa-2x"></i></a>
                                                                        </td>
                                                                    </tr>
                                                                  <?php  } ?>
                                                                <?php endforeach ?>
