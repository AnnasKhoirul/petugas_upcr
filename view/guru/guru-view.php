                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover dataTables-example">
                                                ...
                                                <tbody>
                                                    <?php if (is_array($guru->tampil_all())): $no = 1;?>
                                                        <?php foreach ($guru->tampil_all() as $data):?>
                                                            <tr class="gradeX">
                                                                <td><?php echo $no++; ?></td>
                                                                ...
                                                                <td align="center">
                                                                    <a href="editGuru-view.php?id=<?php echo $data['id']; ?>&aksi1=editG" class="btn m-2 btn-round btn-primary"><i class="fa fa-edit fa-2x"></i></a>
                                                                    <a href="../../model/Validate.php?id=<?php echo $data['id']; ?>&aksi1=hapusG" class="btn m-2 btn-round btn-danger delete"><i class="fa fa-trash fa-2x"></i></a>
                                                                </td>
                                                            </tr>
                                                        <?php endforeach ?>
                                                    <?php endif ?>
