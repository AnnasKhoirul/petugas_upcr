            ...
            <div class="side-menu-area">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="guru-view.php"><i class="fa fa-eye"></i>Guru</a></li>
                            <li><a href="createGuru-view.php"><i class="fa fa-plus-circle"></i>Tambah Guru</a></li>
                        </ul>           
                    </li>
                    <li class="treeview">
                    ...
                    <div class="user-meta-data d-flex align-items-center">
                        ...
                        <div class="topbar-profile">
                            ...
                            <div class="profile-data">
                                ...
                                <!-- Profile List Data -->
                                <a class="profile-list--data" href="class/Validate.php?aksi1=logO2">
                                    <!-- Profile icon -->
                                    <div class="profile--list-icon">
                            ...
                            <div class="col-lg-12">
                                <div class="ibox bg-boxshadow mb-30">
                                    ...
                                    <div class="ibox-content">
                                        <?php foreach ($guru->edit() as $data): ?>
                                            <form action="../../model/Validate.php?aksi1=updateG" method="post">
                                                ...
                                                <div class="form-group row"><label class="col-lg-2 col-form-label">Kode Guru</label>
                                                    <div class="col-lg-10">
                                                        <input value="<?php echo $data['kd_guru']; ?>" type="text" class="form-control" name="kd_guru" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group row"><label class="col-lg-2 col-form-label">Nama</label>
                                                    <div class="col-lg-10">
                                                        <input value="<?php echo $data['nama']; ?>" type="text" class="form-control" name="nama" required="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row"><label class="col-lg-2 col-form-label">Alamat</label>
                                                    <div class="col-lg-10">
                                                        <input value="<?php echo $data['alamat']; ?>" type="text" class="form-control" name="alamat" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group row"><label class="col-lg-2 col-form-label">No HP</label>
                                                    <div class="col-lg-10">
                                                        <input value="<?php echo $data['no_hp']; ?>" type="number" class="form-control" name="no_hp" required="">
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Line -->
