<div class="modal fade" id="Kompi1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    ...
                    <div class="container-fluid">
                        <form action="../../model/Validate.php?aksi1=tambahJabatan" method="post">
                            ...
                            <div class="form-group row"><label class="col-lg-2 col-form-label">Kompi1</label>
                                <div class="col-lg-10">
                                <select name="kompi_1" class="selectpicker" data-style="btn-select-tag" data-live-search="true" title="Select Kompi1">
