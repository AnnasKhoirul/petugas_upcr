                    ...
                    <div class="container-fluid">
                        <form action="../../model/Validate.php?aksi1=tambahJabatan" method="post">
                            ...
                            <div class="form-group row"><label class="col-lg-2 col-form-label">Pembina</label>
                                <div class="col-lg-10">
                                <select name="pembina" class="selectpicker" data-style="btn-select-tag" data-live-search="true" title="Select Pembina" required="">
                                <?php foreach ($tampil_guru as $dataG): ?>
    ...
    <div class="modal fade" id="Pemimpin" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Create Petugas</h5>
