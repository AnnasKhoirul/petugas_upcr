<div class="modal fade" id="Kompi2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                ...
                <div class="modal-header">
                    ...
                    <div class="container-fluid">
                        <form action="../../model/Validate.php?aksi1=tambahJabatan" method="post">
                            <!-- Form Start -->
                            <div class="form-group row"><label class="col-lg-2 col-form-label">Kompi1</label>
                                <div class="col-lg-10">
                                <select name="kompi_2" class="selectpicker" data-style="btn-select-tag" data-live-search="true" title="Select Kompi2">
