                                                        ...
                                                        <?php foreach ($petugas->tampil_all() as $data):?>
                                                            <tr class="gradeX">
                                                                ...
                                                                <td align="center">
                                                                    ...
                                                                    <?php include 'jabatan-view.php' ?>
                                                                </td>
                                                                <td align="center">
                                                                    <a href="editPetugas-view.php?id=<?php echo $data['id']; ?>&aksi1=editP" class="btn m-2 btn-round btn-primary"><i class="fa fa-edit fa-2x"></i></a>
                                                                    <a href="../../model/Validate.php?id=<?php echo $data['id']; ?>&aksi1=hapusPJ" class="btn m-2 btn-round btn-danger delete"><i class="fa fa-trash fa-2x"></i></a>
                                                                </td>
                                                            </tr>
                                                            <?php endforeach ?>
                                                        <?php endif ?>
