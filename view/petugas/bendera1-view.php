<div class="modal fade" id="Bendera1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                ...
                <div class="modal-header">
                    ...
                    <div class="container-fluid">
                        <form action="../../model/Validate.php?aksi1=tambahJabatan" method="post">
                            <!-- Form Start -->
                            <div class="form-group row"><label class="col-lg-2 col-form-label">Bendera1</label>
                                <div class="col-lg-10">
                                <select name="bendera1" class="selectpicker" data-style="btn-select-tag" data-live-search="true" title="Select Bendera1">
                                <?php foreach ($tampil_kelasU as $dataK): $cek = $_SESSION['kel'];?>
                                    <?php if ($dataK['kelas']==$cek): ?>
                                        <option data-tokens="ketchup mustard" value="<?php echo $dataK['nama']; ?>" data-subtext="<?php echo $dataK['kelas']; ?>"
                                        <?php if ($dataK['nama'] == $tampil_jabatan[0]['pemimpin']): ?> disabled
