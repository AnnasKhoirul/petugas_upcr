                            ...
                            <div class="col-lg-12">
                                <div class="ibox bg-boxshadow mb-30">
                                    ...
                                    <div class="ibox-content">
                                        <?php foreach ($petugas->edit() as $data): ?>
                                            <form action="../../model/Validate.php?aksi1=updateP" method="post">
                                                <input value="<?php echo $data['id']; ?>" type="hidden" name="id">
                                                <!-- Form Start -->
                                                <div class="form-group row"><label class="col-lg-2 col-form-label">Nama Upacara</label>
                                                    <div class="col-lg-10">
                                                        <input value="<?php echo $data['nama_upcr']; ?>" type="text" class="form-control" name="nama_upcr" placeholder="Nama Upacara" required="">
                                                    </div>
                                                </div>

                                                <div class="form-group row"><label class="col-lg-2 col-form-label">Tanggal</label>

                                                    <div class="col-lg-10">
                                                      <input value="<?php echo $data['tanggal']; ?>" type="date" class="form-control" name="tanggal" placeholder="Tanggal" required="">
                                                  </div>
                                              </div>
                                                ...
                                                <div class="col-lg-10">
                                                  <select name="kelas" class="selectpicker" data-style="btn-select-tag">
                                                    <?php foreach ($kelas->tampil_all() as $dataK): ?>
                                                        <?php if ($dataK['kelas']==$data['kelas']): ?>
                                                            <option value="<?php echo $dataK['kelas']; ?>" selected><?php echo $dataK['kelas']; ?></option>
                                                        <?php endif ?>
                                                        <?php if ($dataK['kelas'] != $data['kelas']): ?>
                                                            <option value="<?php echo $dataK['kelas']; ?>" disabled="disabled"><?php echo $dataK['kelas']; ?></option>
                                                        <?php endif ?>
                                                    <?php endforeach ?>
                                                </select>
                                            </div>
