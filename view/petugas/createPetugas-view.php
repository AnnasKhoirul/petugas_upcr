                            ...
                            <div class="col-lg-12">
                                <div class="ibox bg-boxshadow mb-30">
                                    ...
                                    <div class="ibox-content">
                                        <form action="../../model/Validate.php?aksi1=tambahPetugas" method="post">
                                          <!-- Form Start -->
                                          <div class="form-group row"><label class="col-lg-2 col-form-label">Nama Upacara</label>
                                            <div class="col-lg-10">
                                              <input value="" type="text" class="form-control" name="nama_upcr" placeholder="Nama Upacara" required>
                                          </div>
                                      </div>

                                      <div class="form-group row"><label class="col-lg-2 col-form-label" for="date_added">Tanggal</label>

                                        <div class="col-lg-10">
                                          <input value="" type="date" id="date_added" class="form-control" name="tanggal" placeholder="Tanggal" required>
                                      </div>
                                  </div>
                                  <div class="form-group row"><label class="col-lg-2 col-form-label">Kelas</label>

                                    <div class="col-lg-10">
                                      <select name="kelas" class="selectpicker" data-style="btn-select-tag" selected="choice" title="Select Kelas" required>
                                        <?php foreach ($kelas->tampil_all() as $dataK): ?>
                                            <option value="<?php echo $dataK['kelas']; ?>|<?php echo $dataK['id']?>"><?php echo $dataK['kelas']; ?></option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                            </div>
