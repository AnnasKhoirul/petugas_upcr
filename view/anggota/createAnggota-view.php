                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="anggota-view.php"><i class="fa fa-eye"></i>Anggota</a></li>
                            <li  class="active"><a href="createAnggota-view.php"><i class="fa fa-plus-circle"></i>Tambah Anggota</a></li>
                        </ul>
                    </li>
                     <li class="treeview">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="ibox bg-boxshadow mb-30">
                                    ...
                                    <div class="ibox-content">
                                        <form action="../../model/Validate.php?aksi1=tambahUser" method="post">
                                          <!-- Form Start -->
                                          <div class="form-group row"><label class="col-lg-2 col-form-label">NIS</label>
                                            <div class="col-lg-10">
                                              <input value="" type="text" class="form-control" name="nis" placeholder="NIS" required="">
                                          </div>
                                      </div>
                               ...
                               <div class="form-group row"><label class="col-lg-2 col-form-label">Kelas</label>
                                ...
                                <div class="col-lg-10">
                                  <select name="kelas" class="selectpicker" data-style="btn-select-tag" selected="choice" title="Select Kelas">
                                    <?php foreach ($kelas->tampil_all() as $key => $dataK): ?>
                         ...
                         <div class="form-group row"><label class="col-lg-2 col-form-label">Role</label>
                                ...
                                <div class="col-lg-10">
                                  <select name="role_id" class="selectpicker" data-style="btn-select-tag" selected="choice">
