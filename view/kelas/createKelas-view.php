            ...
            <div class="side-menu-area">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="kelas-view.php"><i class="fa fa-eye"></i>Kelas</a></li>
                            <li class="active"><a href="createKelas-view.php"><i class="fa fa-plus-circle"></i>Tambah Kelas</a></li>
                        </ul>           
                    </li>
                     <li class="treeview">
                            ...
                            <div class="col-lg-12">
                                <div class="ibox bg-boxshadow mb-30">
                                    ...
                                    <div class="ibox-content">
                                        <form action="../../model/Validate.php?aksi1=tambahKelas" method="post">
                                          <!-- Form Start -->
                                          <div class="form-group row"><label class="col-lg-2 col-form-label">Kelas</label>
                                            <div class="col-lg-10">
                                              <input value="" type="text" class="form-control" name="kelas" placeholder="Kelas" required="">
                                          </div>
                                      </div>
                                      <!-- Line -->
                                      ...
                                      <div class="form-group mb-0 row">
                                        <div class="col-12">
                                            <a href="kelas-view.php" style="color: silver">
