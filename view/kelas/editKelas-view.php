                            ...
                            <div class="col-lg-12">
                                <div class="ibox bg-boxshadow mb-30">
                                    ...
                                    <div class="ibox-content">
                                        <?php foreach ($kelas->edit() as $data): ?>
                                            <form action="../../model/Validate.php?aksi1=updateK" method="post">
                                                <input value="<?php echo $data['id']; ?>" type="hidden" name="id">
                                                <!-- Form Start -->
                                                <div class="form-group row"><label class="col-lg-2 col-form-label">Kelas</label>
                                                    <div class="col-lg-10">
                                                        <input value="<?php echo $data['kelas']; ?>" type="text" class="form-control" name="kelas" required="">
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Line -->
